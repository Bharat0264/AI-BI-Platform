...
Production persistence uses SQLAlchemy models and Alembic migrations with PostgreSQL selected by `DATABASE_URL`; SQLite remains the local compatibility path.
